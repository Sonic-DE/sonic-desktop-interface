    ...
    MouseEventListener {
        ...
        FocusScope {
            ...
            Kirigami.InlineMessage {
                ...
                text: i18nc("@info", "Oh deary me, you seem to have an awful lot of icons on your desktop. We can't deal with that many and may make an oopsie whoopsie. Please take some away UwU.")
                // Note: the trigger amount is intetionally lower than the screen mapping cap. We want to warn ahead of hitting our caps
