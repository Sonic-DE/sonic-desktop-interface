...
QQC2.ScrollView {
    ...
    readonly property Item firstItem: listView.count > 0 ? listView.itemAtIndex(0) : null
    readonly property Item lastItem: listView.count > 0 ? listView.itemAtIndex(listView.count - 1) : null
