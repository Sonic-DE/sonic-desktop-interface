...
KCM.SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        QQC2.ComboBox {
            ...
            Kirigami.FormData.label: i18nc("@label:listbox", "For active application:")

            enabled: Plasmoid.formFactor === PlasmaCore.Types.Horizontal

            model: [
                i18nc("@item:inlistbox what to show for active application in horizontal panel", "Show icon and name"),
                i18nc("@item:inlistbox what to show for active application in horizontal panel", "Show icon only"),
                i18nc("@item:inlistbox what to show for active application in horizontal panel", "Show name only")
            ]
