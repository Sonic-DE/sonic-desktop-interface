...
EmptyPage {
    ...
    Layout.minimumWidth: normalPage.implicitWidth
    Layout.maximumWidth: PlasmaCore.Units.gridUnit * 80
    Layout.minimumHeight: normalPage.implicitHeight + header.implicitHeight
    Layout.maximumHeight: PlasmaCore.Units.gridUnit * 40
    Layout.preferredWidth: Math.max(contentItemStackView.currentItem.implicitWidth, width)
    Layout.preferredHeight: Math.max(contentItemStackView.currentItem.implicitHeight + header.implicitHeight, height)
