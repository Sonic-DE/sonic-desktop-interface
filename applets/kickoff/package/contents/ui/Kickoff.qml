...
Item {
    ...
    readonly property int minimumGridRowCount: Math.min(Screen.desktopAvailableWidth, Screen.desktopAvailableHeight) < KickoffSingleton.gridCellSize * 4 + Plasmoid.fullRepresentationItem.normalPage.preferredSideBarWidth ? 2 : 4
    //END
