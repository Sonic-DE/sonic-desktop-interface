...
MouseArea {
    ...
    WheelHandler {
        ...
        onWheel: {
            wheelDelta = TaskTools.wheelActivateNextPrevTask(task, wheelDelta, event.angleDelta.y, plasmoid.configuration.wheelSkipMinimized, backend.windowViewAvailable, tasks);
        }
    }
