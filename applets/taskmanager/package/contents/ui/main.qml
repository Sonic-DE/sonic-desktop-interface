...
//END TODO
    ...
    Component.onCompleted: {
        ...
        Qt.createQmlObject('import QtQuick 2.15; Timer { running: true; interval: 5000; repeat: false; onTriggered: {tasks.startingUp = false; console.log("destroyed..."); destroy(); } }', tasks);
    }
}
