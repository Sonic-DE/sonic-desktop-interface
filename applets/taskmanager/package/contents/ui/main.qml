...
PlasmoidItem {
    ...
    Layout.preferredWidth: Math.max(0.01, taskList.totalLength)
    Layout.preferredHeight: Math.max(0.01, taskList.totalLength)
        ...
        TriangleMouseFilter {
            ...
            PlasmaComponents3.ScrollView {
                ...
                PlasmaComponents3.ScrollBar.vertical: PlasmaComponents3.ScrollBar {
                    parent: scrollView
                    x: scrollView.mirrored ? 0 : scrollView.width - (visible ? width : 0)
