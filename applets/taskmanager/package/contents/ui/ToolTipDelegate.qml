        ...
        PlasmaComponents3.ScrollView {
            ...
            ListView {
                ...
                model: DelegateModel {
                    ...
                    onEstimatedHeightChanged: console.log("onEstimatedHeightChanged", estimatedHeight, (toolTipDelegate.isVerticalPanel ? count : 1) * (toolTipDelegate.tooltipInstanceMaximumWidth / 2 + PlasmaCore.Units.largeSpacing) - PlasmaCore.Units.largeSpacing);
