    ...
    mainItem: MouseHandler {
        ...
        PlasmaComponents3.ScrollView {
            ...
            ListView {
                ...
                readonly property real maxHeight: groupFilter.count * (taskList.verticalMargins + Math.max(Kirigami.Units.iconSizes.sizeForLabels, Kirigami.Units.iconSizes.medium))
