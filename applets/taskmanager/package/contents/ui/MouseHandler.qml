...
Item {
    ...
    WheelHandler {
        ...
        onWheel: {
            wheelDelta = TaskTools.wheelActivateNextPrevTask(null, wheelDelta, event.angleDelta.y, plasmoid.configuration.wheelSkipMinimized, backend.windowViewAvailable, tasks);
        }
    }
