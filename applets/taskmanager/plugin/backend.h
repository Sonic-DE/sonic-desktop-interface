...
class Backend : public QObject
{
    ...
    Q_PROPERTY(bool appViewAvailable READ appViewAvailable NOTIFY appViewAvailableChanged)
...
public Q_SLOTS:
    void activateAppView(const QVariant &winIds);
