...
Item {
    ...
    readonly property rect editModeRect: {
        ...
        if (sidePanel.visible) {
            if (sidePanel.rightEdgeSidePanel) {
    ...
    PlasmaCore.Dialog {
        id: sidePanel
        location: rightEdgeSidePanel ? PlasmaCore.Types.RightEdge : PlasmaCore.Types.LeftEdge
        ...
        property bool rightEdgeSidePanel: rightEdgeParent || Qt.application.layoutDirection === Qt.RightToLeft
