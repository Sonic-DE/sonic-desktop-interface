...
Item {
    ...
    TaskManager.TasksModel {
        ...
        regionGeometry: panel.thickness, panel.offset, panel.length, panel.location, panel.geometryByDistance(1 /* Touch the border */ + Math.max(bottomFloatingPadding, topFloatingPadding, leftFloatingPadding, rightFloatingPadding))
