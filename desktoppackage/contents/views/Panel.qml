...
Item {
    ...
    property double fixedFloatingness: 0
    ...
    // The alias is read from panelview.cpp and is used as an offset for the mask
    readonly property alias floatingTranslucentItem: floatingTranslucentItem
