...
Item {
    ...
    TaskManager.TasksModel {
        ...
        Binding on regionGeometry {
            delayed: true
            value: panel.thickness, panel.offset, panel.length, panel.location, panel.geometryByDistance(1 /* Touch the border */ + Math.max(bottomFloatingPadding, topFloatingPadding, leftFloatingPadding, rightFloatingPadding))
        }
    }
