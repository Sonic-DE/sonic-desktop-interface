        ...
        mainItem: MouseEventListener {
            ...
            width: {
                if (root.fullRepresentation !== null) {
                    /*if*/ if (root.fullRepresentation.Layout.preferredWidth > 0) {
                    ...
                    } else if (root.fullRepresentation.width > 0) {
                        return root.fullRepresentation.width;
                    }
                }
            ...
            height: {
                if (root.fullRepresentation !== null) {
                    /*if*/ if (fullRepresentation.Layout.preferredHeight > 0) {
