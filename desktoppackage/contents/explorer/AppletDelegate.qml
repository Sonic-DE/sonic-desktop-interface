    ...
    ColumnLayout {
        ...
        Item {
            ...
            Rectangle {
                ...
                radius: height
                color: running ? Kirigami.Theme.highlightColor : Kirigami.Theme.positiveTextColor
                ...
                PlasmaComponents.Label {
                    ...
                    text: running ? running : i18nd("Text displayed on top of newly installed widgets", "New!")
