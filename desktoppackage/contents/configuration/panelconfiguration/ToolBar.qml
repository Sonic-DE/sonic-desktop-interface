...
Item {
    ...
    GridLayout {
        ...
        PlasmaComponents3.SpinBox {
            ...
            from: Math.max(20, (plasmoid.formFactor === PlasmaCore.Types.Horizontal ? panelSvg.fixedMargins.vertical : panelSvg.fixedMargins.horizontal)) // below this size, the panel is mostly unusable
