...
PlasmaCore.FrameSvgItem {
    ...
    property string maximumText: dialogRoot.vertical ? i18n("Maximum height") : i18n("Maximum width")
    property string minimumText: dialogRoot.vertical ? i18n("Minimum height") : i18n("Minimum width")
