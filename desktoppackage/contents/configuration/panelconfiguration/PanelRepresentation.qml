        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    width: isVertical ? Math.round(parent.width / 6): Math.round(parent.width * 0.8)
                    height: isVertical ? Math.round(parent.height * 0.8) : Math.round(parent.height / 4)
                    Layout.alignment: alignment
                    Layout.bottomMargin: sunkenPanel * -Math.round(height / 2)
