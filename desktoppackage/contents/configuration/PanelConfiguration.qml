    ...
    GridLayout {
        ...
        ColumnLayout {
            ...
            PC3.ComboBox {
                ...
                readonly property int previewIndex: popup.visible ? highlightedIndex : currentIndex
                model: [
                    i18nd("plasma_shell_org.kde.plasma.desktop", "Disabled"),
                    i18nd("plasma_shell_org.kde.plasma.desktop", "Applets only"),
                    i18nd("plasma_shell_org.kde.plasma.desktop", "Panel and applets")
                ]
                Layout.alignment: Qt.AlignHCenter
                Layout.minimumHeight: transparencyBox.height
                Layout.minimumWidth: opacityRepresentation.width
