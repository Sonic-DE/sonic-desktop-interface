...
class DesktopTest(unittest.TestCase):
    ...
    def test_3_containment_config_dialog_0_prepare(self) -> None:
        self._enter_edit_mode()
    ...
    def test_3_containment_config_dialog_1_open(self) -> None:
        ...
        """
        self.driver.find_element(AppiumBy.NAME, "Configure Desktop and Wallpaper…").click()
        wait = WebDriverWait(self.driver, 30)
    ...
    def test_3_containment_config_dialog_2_change_wallpaper_type(self) -> None:
        ...
        """
        self.driver.set_value(self.driver.find_element(AppiumBy.NAME, "Wallpaper type combobox"), "2")  # Plain Color
        wait = WebDriverWait(self.driver, 30)
        self.driver.find_element(AppiumBy.NAME, "Color:")
    ...
    def test_3_containment_config_dialog_3_other_sections(self) -> None:
        ...
        """
        self.test_3_containment_config_dialog_0_prepare()
        ...
        wait.until(EC.presence_of_element_located((AppiumBy.NAME, "File name pattern"))).click()
