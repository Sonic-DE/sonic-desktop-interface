...
""")
        ...
        os.makedirs("/builds/plasma/plasma-desktop/_install/etc/xdg/menus")
        shutil.copy2(os.path.join(os.getcwd(), "resources", "applications.menu"), "/builds/plasma/plasma-desktop/_install/etc/xdg/menus/applications.menu")
