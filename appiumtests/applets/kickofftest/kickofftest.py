...
class KickoffTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        for f in ("org.kde.kontact.desktop", "systemsettings.desktop", "org.kde.dolphin.desktop", "org.kde.discover.desktop"):
            shutil.copy(os.path.join(os.path.dirname(os.path.abspath(__file__)), f), os.path.join(GLib.get_user_data_dir(), "applications"))
