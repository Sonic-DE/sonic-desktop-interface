...
void KAccessApp::readSettings()
{
    ...
    m_currentPlayerSource = QUrl(cg.readPathEntry("ArtsBellFile", QUrl::fromLocalFile("KDE_INSTALL_SOUNDDIR/freedesktop/stereo/bell.oga").toString()));
    qCritical() << m_currentPlayerSource;
