...
void KAccessApp::readSettings()
{
    ...
    if (!m_bellSettings.customBell() && !m_bellSettings.visibleBell()
        && !(m_activationGesturesSettings.gestures() && m_activationGesturesSettings.gestureConfirmation()) && !m_keyboardSettings.keyboardNotifyModifiers()
