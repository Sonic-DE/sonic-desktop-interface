...
MouseArea {
    ...
    Row {
        ...
        PlasmaComponents3.ToolButton {
            ...
            Accessible.name: i18ndc("plasma_toolbox_org.kde.desktoptoolbox", "@action:button", "More")
            ...
            onClicked: {
                ...
                const incubator = component.incubateObject(menuButton);
                component.destroy();
            }

            PlasmaComponents3.ToolTip {
                text: menuButton.Accessible.name
            }
        }
