...
class EmojiParser(object):
    ...
    def writeEmojiCategory(self):
        template_header='''// Generated from emoji-test.txt
...
with zipfile.ZipFile(io.BytesIO(response.content)) as thezip:
    # Extract unicode license
    with open("../../LICENSES/Unicode-DFS-2016.txt", "wb") as f:
        f.write(thezip.open("LICENSE.txt").read())
