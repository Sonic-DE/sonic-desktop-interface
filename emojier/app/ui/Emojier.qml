...
Kirigami.ApplicationWindow
{
    ...
    Kirigami.Action {
        ...
        onTriggered: {
            window.pageStack.replace("qrc:/qt/qml/org/kde/plasma/emoji/app/CategoryPage.qml", {title: text, category: "", model: recentEmojiModel, showClearHistoryButton: true})
        }
    }
    Kirigami.Action {
        id: searchAction
        ...
        onTriggered: {
            window.pageStack.replace("qrc:/qt/qml/org/kde/plasma/emoji/app/CategoryPage.qml", {title: text, category: "", model: emoji, showSearch: true })
        }
    }
