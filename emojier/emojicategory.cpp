...
const QStringList &getCategoryNames()
{
    static const QStringList names = {
        I18N_NOOP2("Emoji Category", "Smileys & Emotion"),
        I18N_NOOP2("Emoji Category", "People & Body"),
        I18N_NOOP2("Emoji Category", "Component"),
        I18N_NOOP2("Emoji Category", "Animals & Nature"),
        I18N_NOOP2("Emoji Category", "Food & Drink"),
        I18N_NOOP2("Emoji Category", "Travel & Places"),
