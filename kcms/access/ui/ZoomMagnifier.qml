...
Kirigami.FormLayout {
    ...
    RowLayout {
        ...
        Item {
            implicitWidth: zoomRadioButton.contentItem.leftPadding // Simulate left padding for FormLayout // TODO RTL
        }
        ...
        Kirigami.FormLayout {
            ...
            // TODO: Only show on Wayland
            // TODO: Implement support for "Control" alternative for "Ctrl" modifier in zoom effect
            KQuickControls.KeySequenceItem {
                ...
                onKeySequenceModified: { kcm.zoomMagnifierSettings.zoomPointerAxisGestureModifiers = keySequence; console.log(keySequence) }
                modifierOnlyAllowed: true
                multiKeyShortcutsAllowed: false

                Component.onCompleted: console.log(kcm.zoomMagnifierSettings.zoomPointerAxisGestureModifiers)
            ...
            QQC2.Label {
                ...
                text: i18nc("@label Hint for scroll gesture modifiers input", "Scroll while modifier keys are pressed to zoom")
    ...
    RowLayout {
        ...
        Item {
            implicitWidth: magnifierRadioButton.contentItem.leftPadding // Simulate left padding for FormLayout // TODO RTL
        }
