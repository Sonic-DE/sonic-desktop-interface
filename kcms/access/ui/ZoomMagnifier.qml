...
Kirigami.FormLayout {
    ...
    RowLayout {
        ...
        Item {
            implicitWidth: Qt.application.layoutDirection === Qt.RightToLeft ? magnifierRadioButton.contentItem.rightPadding : magnifierRadioButton.contentItem.leftPadding // Simulate left padding for FormLayout
        }
