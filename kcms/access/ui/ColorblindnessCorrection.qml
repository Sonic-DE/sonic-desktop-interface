...
ColumnLayout {
    ...
    QQC2.Label {
        ...
        text: i18nc("@info", "If you have difficulty seeing certain colors on the screen, these filters can change them into other colors.")
    ...
    Kirigami.FormLayout {
        ...
        QQC2.ComboBox {
            id: colorComboBox
            Kirigami.FormData.label: i18nc("@label:listbox Difficulty seeing any of the following colors on the screen", "Difficulty seeing:")
            currentIndex: kcm.colorblindnessCorrectionSettings.mode
            textRole: "text"
            valueRole: "value"
            model: [
                { value: 0, text: i18nc("@option", "Red and purple (Protanopia)") },
                { value: 1, text: i18nc("@option", "Green and purple (Deuteranopia)") },
                { value: 2, text: i18nc("@option", "Yellow, green, and purple (Tritanopia)") },
            ]
    ...
    ColumnLayout {
        ...
        QQC2.Label {
            ...
            text: i18nc("@info", "This is how the colors on the screen look:")
            textFormat: Text.PlainText
            wrapMode: Text.WordWrap
            horizontalAlignment: Text.AlignHCenter
        }
