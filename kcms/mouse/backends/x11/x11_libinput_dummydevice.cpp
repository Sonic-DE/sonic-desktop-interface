    ...
    , m_dpy(dpy)
{
    ...
    m_x11DefaultPointerAccelerationProfileFlat.val = m_settings->load(m_x11DefaultPointerAccelerationProfileFlat.cfgName, false);

    m_defaultPointerAccelerationProfileFlat.val = m_x11DefaultPointerAccelerationProfileFlat.val;
    m_defaultPointerAccelerationProfileAdaptive.val = !m_x11DefaultPointerAccelerationProfileFlat.val;
...
void X11LibinputDummyDevice::readDefaultsFromX()
{
    ...
    m_settings->save(m_x11DefaultPointerAccelerationProfileFlat.cfgName, flatProfile);
}
