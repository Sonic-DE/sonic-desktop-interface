...
*/
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            model: ListModel {
                ListElement { trigger: "Swipe up with 3 fingers"; triggerSection: "Swipe"; component: "Window Management"; componentIcon: "kwin"; actionText: "Cycle through Window Overview and Desktop Grid" }
                ListElement { trigger: "Swipe right with 3 fingers"; triggerSection: "Swipe"; component: "Window Management"; componentIcon: "kwin"; actionText: "Walk through Windows" }
                ListElement { trigger: "Swipe left with 3 fingers"; triggerSection: "Swipe"; component: "Window Management"; componentIcon: "kwin"; actionText: "Walk through Windows - backwards" }
                ListElement { trigger: "Swipe up with 4 fingers"; triggerSection: "Swipe"; component: "Window Management"; componentIcon: "kwin"; actionText: "Cycle through Desktop Grid and Window Overview" }
                ListElement { trigger: "Swipe right with 4 fingers"; triggerSection: "Swipe"; component: "Window Management"; componentIcon: "kwin"; actionText: "Switch to Next Desktop" }
                ListElement { trigger: "Swipe left with 4 fingers"; triggerSection: "Swipe"; component: "Window Management"; componentIcon: "kwin"; actionText: "Switch to Previous Desktop" }
                ListElement { trigger: "Spread with 3 fingers"; triggerSection: "Pinch"; component: "Window Management"; componentIcon: "kwin"; actionText: "Zoom In Screen" }
                ListElement { trigger: "Pinch with 3 fingers"; triggerSection: "Pinch"; component: "Window Management"; componentIcon: "kwin"; actionText: "Peek at Desktop" }
                ListElement { trigger: "Pinch with 4 fingers"; triggerSection: "Pinch"; component: "Window Management"; componentIcon: "preferences-system-login"; actionText: "Lock Session" }
                ListElement { trigger: "Rotate clockwise with 3 fingers"; triggerSection: "Rotate"; component: "Window Management"; componentIcon: "kmix"; actionText: "Increase Volume" }
                ListElement { trigger: "Rotate counter-clockwise with 3 fingers"; triggerSection: "Rotate"; component: "Window Management"; componentIcon: "kmix"; actionText: "Decrease Volume" }
                ListElement { trigger: "Rotate clockwise with 4 fingers"; triggerSection: "Rotate"; component: "Window Management"; componentIcon: "preferences-system-power-management"; actionText: "Increase Screen Brightness" }
                ListElement { trigger: "Rotate counter-clockwise with 4 fingers"; triggerSection: "Rotate"; component: "Window Management"; componentIcon: "preferences-system-power-management"; actionText: "Decrease Screen Brightness" }
            }
