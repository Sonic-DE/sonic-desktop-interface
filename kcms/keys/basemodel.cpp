...
QVariant BaseModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole: {
        ...
        if (component.displayName == i18nc("Translated name for KWin; keep in sync with the translation for kwin's KAboutData", "KWin")) {
            return i18nc("@item:intable", "Window Management");
        }
        if (component.displayName == i18nc("Translated name for plasmashell; keep in sync with the translation for plasmashell's KAboutData", "plasmashell")) {
