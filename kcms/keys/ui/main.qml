...
KCM.AbstractKCM {
    ...
    PComp.Menu {
        ...
        PComp.MenuItem {
            ...
            text: i18nc("@action:menu Keep translated text as short as possible", "Add Application…")
            onTriggered: kcm.addApplication(root)
        }

        PComp.MenuItem {
            icon.name: "new-command-alarm-symbolic"
            text: i18nc("@action:menu Keep translated text as short as possible", "Add Command or Script…")
    ...
    actions: [
        /*Kirigami.Action {
            ...
            onTriggered: shortcutMenu.popup()
        },*/ Kirigami.Action {
            enabled: !exportActive
...
//                onClicked: shortcutMenu.popup(tb
//                                              , tb.x - Kirigami.Units.largeSpacing
//                                              , tb.y + tb.height - Kirigami.Units.largeSpacing)
//            }
