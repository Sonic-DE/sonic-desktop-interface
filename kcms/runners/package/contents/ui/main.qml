...
KCM.SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        QQC2.RadioButton {
            checked: kcm.krunnerSettings.freeFloating
            onCheckedChanged: kcm.krunnerSettings.freeFloating = checked
            QQC2.ButtonGroup.group: positionGroup
            text: i18n("Center")
        ...
        QQC2.Button {
            ...
            text: kcm.hasSingleHistory ?
                    (!kcm.krunnerSettings.activityAware ?
                        i18n("Clear History")
                      : i18nc("@action:button %1 activity name", "Clear History for %1", kcm.singleActivityName))
                  : i18n("Clear History…")
        ...
        Loader {
            id: pluginButton
            active: kcm.doesShowPluginButton && KCMShell.authorize("kcm_krunnersettings.desktop").length > 0
            visible: active
