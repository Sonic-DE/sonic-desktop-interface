...
KCMUtils.ScrollViewKCM {
    ...
    header: ColumnLayout {
        ...
        QQC2.Label {
            text: i18n("Enable or disable plugins (used in KRunner, Application Launcher, and the Overview effect). Mark plugins as favorites and rearrange them in the fixed order you want them to be shown")
