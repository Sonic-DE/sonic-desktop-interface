...
InputDevice::InputDevice(QString dbusName)
{
    ...
    connect(this, &InputDevice::fittingChanged, this, &InputDevice::needsSaveChanged);
}
...
{
    return m_leftHanded.changed() || m_orientation.changed() || m_outputName.changed() || m_fitting.changed();
}
...
void InputDevice::defaults()
{
    ...
    m_fitting.resetFromDefaults();
}

bool InputDevice::isDefaults() const
{
    return m_leftHanded.isDefaults() && m_orientation.isDefaults() && m_outputName.isDefaults() && m_fitting.isDefaults();
}
