...
SimpleKCM {
    ...
    Kirigami.FormLayout {
        ...
        Item {
            ...
            Output {
                id: outputItem
                readonly property size outputPhysicalSize: outputsCombo.model.data(outputsCombo.model.index(outputsCombo.currentIndex, 0), Qt.UserRole + 1)
                readonly property size outputSize: outputsCombo.model.data(outputsCombo.model.index(outputsCombo.currentIndex, 0), Qt.UserRole + 2)
