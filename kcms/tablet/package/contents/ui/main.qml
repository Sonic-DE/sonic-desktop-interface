            ...
            Rectangle {
                ...
                QQC2.Button {
                    ...
                    DragHandler {
                        ...
                        yAxis.minimum: tabletSizeHandle.checked ? (tabletItem.width / tabletItem.aspectRatio) : 10
                        yAxis.maximum: tabletSizeHandle.checked ? (tabletItem.width / tabletItem.aspectRatio) : outputItem.height - tabletItem.y
                    }
                }
            }
        }
