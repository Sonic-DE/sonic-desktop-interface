    ...
    Kirigami.FormLayout {
        ...
        Repeater {
            ...
            delegate: KeySequenceItem {
                ...
                keySequence: kcm.toolButtonMapping(form.padDevice.name, modelData.value)
                Connections {
                    target: kcm
                    function onToolButtonMappingChanged() {
                        seq.keySequence = kcm.padButtonMapping(form.padDevice.name, modelData.value)
                    }
                }
                ...
                onCaptureFinished: {
                    kcm.assignToolButtonMapping(form.padDevice.name, modelData.value, keySequence)
                }
            }
        }
