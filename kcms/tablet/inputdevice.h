...
private:
    ...
    Prop<QRectF> m_fitting = Prop<QRectF>(this,
                                          "fitting",
                                          &OrgKdeKWinInputDeviceInterface::defaultFitting,
                                          &OrgKdeKWinInputDeviceInterface::supportsFitting,
                                          &InputDevice::fittingChanged);
