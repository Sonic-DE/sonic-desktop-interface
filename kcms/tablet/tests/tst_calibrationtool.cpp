...
private Q_SLOTS:
    ...
    void testPerfectCalibration()
    {
        ...
        // upper left
        tool.calibrate(50.0f, 50.0f, 50.0f, 50.0f);
        QCOMPARE(targetChangedSpy.count(), 1);

        // upper right
        tool.calibrate(450.0f, 50.0f, 450.0f, 50.0f);
        QCOMPARE(targetChangedSpy.count(), 2);

        // lower left
        tool.calibrate(50.0f, 450.0f, 50.0f, 450.0f);
        QCOMPARE(targetChangedSpy.count(), 3);

        // lower right
        tool.calibrate(450.0f, 450.0f, 450.0f, 450.0f);
