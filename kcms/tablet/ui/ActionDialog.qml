...
Kirigami.Dialog {
    ...
    ColumnLayout {
        ...
        QQC2.Label {
            text: i18ndc("kcm_tablet", "@info", "Choose what action will be taken when pressing this pen button:")
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ModifierCheckBox {
                        ...
                        text: i18ndc("kcm_tablet", "@option:check", "Ctrl")
                    ...
                    ModifierCheckBox {
                        ...
                        text: i18ndc("kcm_tablet", "@option:check", "Alt")
                    ...
                    ModifierCheckBox {
                        ...
                        text: i18ndc("kcm_tablet", "@option:check", "Meta")
                    ...
                    ModifierCheckBox {
                        ...
                        text: i18ndc("kcm_tablet", "@option:check", "Shift")
