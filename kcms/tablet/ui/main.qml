    ...
    Kirigami.FormLayout {
        ...
        QQC2.ComboBox {
            ...
            function reloadOutputView() {
                ...
                if (outputsCombo.currentIndex !== 0) {
                    mappingLoader.item.setOutputAreaMode(outputAreaCombo.currentIndex);
                    mappingLoader.item.setOutputArea(initialOutputArea);
                }
            }
            ...
            Connections {
                ...
                function onSettingsRestored() {
                    mappingLoader.item.changed = false
        ...
        QQC2.ComboBox {
            ...
            model: outputsCombo.currentIndex === 0 ?
                ...
                [i18n("Stretch and Fill"), i18n("Keep Aspect Ratio and Fit")] :
                [i18n("Stretch and Fill"), i18n("Keep Aspect Ratio and Fit"), i18n("Map to Portion")]
            onActivated: index => {
                mappingLoader.item.changed = true;
                mappingLoader.item.setOutputAreaMode(index);
            }
            SettingHighlighter {
        ...
        Loader {
            ...
            active: form.device && outputsCombo.currentIndex !== 0
            visible: active
