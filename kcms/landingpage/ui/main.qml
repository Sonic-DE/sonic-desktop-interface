    ...
    Kirigami.FormLayout {
        ...
        RowLayout {
            ...
            Thumbnail {
                ...
                QQC2.ToolTip.text: i18nc("@info:tooltip 1 is the name of a light global theme, 2 is the name of the dark global theme", 'Use "%1" during day and "%2" during night', lightLookAndFeelMetaData.name, darkLookAndFeelMetaData.name)
