...
KCM.SimpleKCM {
    ...
    GeoJsonData {
        id: geoDatabase
        sourceUrl: "file:/home/niccolove/kde/usr/share/timezonefiles/timezones.json"
    }
        ...
        Kirigami.ShadowedRectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    PC3.Label {
                        text: "You have currently selected the"
                    }
                    ...
                    PC3.Label {
                        text: locationComboBox.visible ? "area in the" : "timezone."
                    }
