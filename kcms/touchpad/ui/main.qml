    ...
    Kirigami.FormLayout {
        ...
        ColumnLayout {
            ...
            Kirigami.FormData.label: (root.device?.tapFingerCount > 2
                ...
                : i18nd("kcm_touchpad", "Two-finger tap:")
            )
            ...
            QQC2.RadioButton {
                ...
                Accessible.description: i18nd("kcm_touchpad", "Right-click by tapping with three fingers")
        ...
        ColumnLayout {
            ...
            QQC2.RadioButton {
                ...
                text: i18ndc("kcm_touchpad", "@option:radio touchpad press to right-click", "Press bottom-right corner")
            ...
            QQC2.RadioButton {
                ...
                text: i18ndc("kcm_touchpad", "@option:radio touchpad press to right-click", "Press touchpad with two fingers")
