...
void migrateConfig(TouchpadBackend *backend)
{
    ...
    // on Wayland, KWin handles the on/off/toggle shortcuts, the kded is not used and X11 settings are not migrated
    ...
    if (migrationGroup.hasKey("MigratedToPlasma6_X11")) {
        return;
    }
